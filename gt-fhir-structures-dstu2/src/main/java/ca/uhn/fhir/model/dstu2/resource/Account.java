...
public class Account extends ca.uhn.fhir.model.dstu2.resource.BaseResource
	 ...
	 * </p>
	 */
	@SearchParamDefinition(name="subject", path="Account.subject", description="", type="reference" , providesMembershipIn={
 @Compartment(name="Patient") ,  @Compartment(name="Encounter") ,  @Compartment(name="RelatedPerson") 	}
	 ...
	 * </p>
	 */
	@SearchParamDefinition(name="owner", path="Account.owner", description="", type="reference" , target={
 ca.uhn.fhir.model.dstu2.resource.Organization.class 	}
	 ...
	 * </p>
	 */
	@SearchParamDefinition(name="patient", path="Account.subject", description="", type="reference" , target={
 ca.uhn.fhir.model.dstu2.resource.Patient.class 	}
	...
	@Child(name="subject", order=8, min=0, max=1, summary=false, modifier=false, type={
		ca.uhn.fhir.model.dstu2.resource.Patient.class, 		ca.uhn.fhir.model.dstu2.resource.Device.class, 		ca.uhn.fhir.model.dstu2.resource.Practitioner.class, 		ca.uhn.fhir.model.dstu2.resource.Location.class, 		ca.uhn.fhir.model.dstu2.resource.HealthcareService.class, 		ca.uhn.fhir.model.dstu2.resource.Organization.class	})
	@Description(
		shortDefinition="",
	...
	@Child(name="owner", order=9, min=0, max=1, summary=false, modifier=false, type={
		ca.uhn.fhir.model.dstu2.resource.Organization.class	})
	@Description(
		shortDefinition="",
	...
	public BoundCodeDt<AccountStatusEnum> getStatusElement() {  
		if (myStatus == null) {
			myStatus = new BoundCodeDt<AccountStatusEnum>(AccountStatusEnum.VALUESET_BINDER);
		}
		return myStatus;
	}
	...
	public Account setStatus(AccountStatusEnum theValue) {
		setStatus(new BoundCodeDt<AccountStatusEnum>(AccountStatusEnum.VALUESET_BINDER, theValue));
...
*/
	...
	/**
	 * Gets the value(s) for <b>activePeriod</b> ().
	 * creating it if it does
	 * not exist. Will not return <code>null</code>.
	 *
     * <p>
	...
	/**
	 * Sets the value(s) for <b>activePeriod</b> ()
	 *
     * <p>
     * <b>Definition:</b>
     * Indicates the period of time over which the account is allowed
	...
	/**
	 * Gets the value(s) for <b>currency</b> ().
	 * creating it if it does
	 * not exist. Will not return <code>null</code>.
	 *
     * <p>
	...
	public CodingDt getCurrency() {  
		if (myCurrency == null) {
			myCurrency = new CodingDt();
		}
		return myCurrency;
	}

	/**
	 * Sets the value(s) for <b>currency</b> ()
	 *
     * <p>
     * <b>Definition:</b>
     * Identifies the currency to which transactions must be converted when crediting or debiting the account.
	...
	/**
	 * Gets the value(s) for <b>balance</b> ().
	 * creating it if it does
	 * not exist. Will not return <code>null</code>.
	 *
     * <p>
	...
	/**
	 * Sets the value(s) for <b>balance</b> ()
	 *
     * <p>
     * <b>Definition:</b>
     * Represents the sum of all credits less all debits associated with the account.  Might be positive, zero or negative.
	...
	/**
	 * Gets the value(s) for <b>coveragePeriod</b> ().
	 * creating it if it does
	 * not exist. Will not return <code>null</code>.
	 *
     * <p>
	...
	/**
	 * Sets the value(s) for <b>coveragePeriod</b> ()
	 *
     * <p>
     * <b>Definition:</b>
     * Identifies the period of time the account applies to; e.g. accounts created per fiscal year, quarter, etc.
