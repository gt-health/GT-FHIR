...
/**
 * HAPI/FHIR <b>Parameters</b> Resource
 ...
 * <a href="http://hl7.org/fhir/profiles/Parameters">http://hl7.org/fhir/profiles/Parameters</a> 
 * </p>
 *
 */
@ResourceDef(name="Parameters", profile="http://hl7.org/fhir/profiles/Parameters", id="parameters")
public class Parameters extends ca.uhn.fhir.model.dstu2.resource.BaseResource
    implements  IResource     , org.hl7.fhir.instance.model.api.IBaseParameters
    {



	@Child(name="parameter", order=0, min=0, max=Child.MAX_UNLIMITED, summary=false, modifier=false)	
	@Description(
		shortDefinition="",
		formalDefinition="A parameter passed to or received from the operation"
	)
	...
	public boolean isEmpty() {
		return super.isBaseEmpty() && ca.uhn.fhir.util.ElementUtil.isEmpty(  myParameter);
	}
	
	@Override
	public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
		return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(theType, myParameter);
	}
     ...
     * </p> 
	 */
	public Parameters setParameter(java.util.List<Parameter> theValue) {
	...
	/**
	 * Block class for child element: <b>Parameters.parameter</b> ()
	 *
     * <p>
     * <b>Definition:</b>
     * A parameter passed to or received from the operation
	...
	@Description(
		shortDefinition="",
		formalDefinition="The name of the parameter (reference to the operation definition)"
	)
	...
	@Description(
		shortDefinition="",
		formalDefinition="If the parameter is a data type"
	)
	...
	@Description(
		shortDefinition="",
		formalDefinition="If the parameter is a whole resource"
	)
	private IResource myResource;
	
	@Child(name="part", type=Parameter.class, order=3, min=0, max=Child.MAX_UNLIMITED, summary=false, modifier=false)	
	@Description(
		shortDefinition="",
		formalDefinition="A named part of a parameter. In many implementation context, a set of named parts is known as a \"Tuple\""
	)
	...
	@Override
	public boolean isEmpty() {
		return super.isBaseEmpty() && ca.uhn.fhir.util.ElementUtil.isEmpty(  myName,  myValue,  myResource,  myPart);
	}
	
	@Override
	public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
		return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(theType, myName, myValue, myResource, myPart);
	}
