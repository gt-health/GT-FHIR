...
/**
 * HAPI/FHIR <b>EnrollmentResponse</b> Resource
 * ()
 *
 * <p>
 * <b>Definition:</b>
 ...
 * <a href="http://hl7.org/fhir/profiles/EnrollmentResponse">http://hl7.org/fhir/profiles/EnrollmentResponse</a> 
 * </p>
 *
 */
@ResourceDef(name="EnrollmentResponse", profile="http://hl7.org/fhir/profiles/EnrollmentResponse", id="enrollmentresponse")
public class EnrollmentResponse extends ca.uhn.fhir.model.dstu2.resource.BaseResource
	...
	@Child(name="request", order=1, min=0, max=1, summary=false, modifier=false, type={
		ca.uhn.fhir.model.dstu2.resource.EnrollmentRequest.class	})
	@Description(
		shortDefinition="",
     ...
     * </p> 
	 */
	public EnrollmentResponse setIdentifier(java.util.List<IdentifierDt> theValue) {
     ...
     * </p> 
	 */
	public EnrollmentResponse setRequest(ResourceReferenceDt theValue) {
		myRequest = theValue;
		return this;
	}
     ...
     * </p> 
	 */
	public EnrollmentResponse setOutcome(BoundCodeDt<RemittanceOutcomeEnum> theValue) {
		myOutcome = theValue;
		return this;
	}
     ...
     * </p> 
	 */
	public EnrollmentResponse setOutcome(RemittanceOutcomeEnum theValue) {
...
*/
     ...
     * </p> 
	 */
	public EnrollmentResponse setDisposition(StringDt theValue) {
     ...
     * </p> 
	 */
	public EnrollmentResponse setDisposition( String theString) {
     ...
     * </p> 
	 */
	public EnrollmentResponse setCreated(DateTimeDt theValue) {
		myCreated = theValue;
		return this;
	}
     ...
     * </p> 
	 */
	public EnrollmentResponse setCreated( Date theDate,  TemporalPrecisionEnum thePrecision) {
     ...
     * </p> 
	 */
	public EnrollmentResponse setCreatedWithSecondsPrecision( Date theDate) {
     ...
     * </p> 
	 */
	public EnrollmentResponse setOrganization(ResourceReferenceDt theValue) {
     ...
     * </p> 
	 */
	public EnrollmentResponse setRequestProvider(ResourceReferenceDt theValue) {
     ...
     * </p> 
	 */
	public EnrollmentResponse setRequestOrganization(ResourceReferenceDt theValue) {
