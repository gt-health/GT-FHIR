 ...
 * <a href="http://hl7.org/fhir/profiles/Flag">http://hl7.org/fhir/profiles/Flag</a> 
 * </p>
 *
 */
@ResourceDef(name="Flag", profile="http://hl7.org/fhir/profiles/Flag", id="flag")
public class Flag extends ca.uhn.fhir.model.dstu2.resource.BaseResource
	 ...
	 * </p>
	 */
	@SearchParamDefinition(name="patient", path="Flag.subject", description="The identity of a subject to list flags for", type="reference" , providesMembershipIn={
...
, target={
 ca.uhn.fhir.model.dstu2.resource.Patient.class 	}
	 ...
	 * </p>
	 */
	@SearchParamDefinition(name="author", path="Flag.author", description="", type="reference" , providesMembershipIn={
 @Compartment(name="Encounter") ,  @Compartment(name="RelatedPerson") 	}
	...
	@Description(
		shortDefinition="id",
		formalDefinition="Identifier assigned to the flag for external use (outside the FHIR environment)"
	)
	...
	@Description(
		...
		formalDefinition="Allows an flag to be divided into different categories like clinical, administrative etc. Intended to be used as a means of filtering which flags are displayed to particular user or in a given context."
	)
	...
	@Description(
		...
		formalDefinition="The period of time from the activation of the flag to inactivation of the flag. If the flag is active, the end of the period should be unspecified."
	)
	private PeriodDt myPeriod;
	
	@Child(name="subject", order=4, min=1, max=1, summary=true, modifier=false, type={
		ca.uhn.fhir.model.dstu2.resource.Patient.class, 		ca.uhn.fhir.model.dstu2.resource.Location.class, 		ca.uhn.fhir.model.dstu2.resource.Group.class, 		ca.uhn.fhir.model.dstu2.resource.Organization.class, 		ca.uhn.fhir.model.dstu2.resource.Practitioner.class	})
	@Description(
		shortDefinition="who.focus",
		formalDefinition="The patient, location, group , organization , or practitioner this is about record this flag is associated with"
	)
	...
	@Description(
		shortDefinition="context",
		formalDefinition="This alert is only relevant during the encounter"
	)
	private ResourceReferenceDt myEncounter;
	
	@Child(name="author", order=6, min=0, max=1, summary=true, modifier=false, type={
		ca.uhn.fhir.model.dstu2.resource.Device.class, 		ca.uhn.fhir.model.dstu2.resource.Organization.class, 		ca.uhn.fhir.model.dstu2.resource.Patient.class, 		ca.uhn.fhir.model.dstu2.resource.Practitioner.class	})
	@Description(
		shortDefinition="who.author",
		formalDefinition="The person, organization or device that created the flag"
	)
	...
	@Description(
		...
		formalDefinition="The coded value or textual component of the flag to display to the user"
	)
	...
	public boolean isEmpty() {
		return super.isBaseEmpty() && ca.uhn.fhir.util.ElementUtil.isEmpty(  myIdentifier,  myCategory,  myStatus,  myPeriod,  mySubject,  myEncounter,  myAuthor,  myCode);
	}
	
	@Override
	public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
		return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(theType, myIdentifier, myCategory, myStatus, myPeriod, mySubject, myEncounter, myAuthor, myCode);
	}
     ...
     * </p> 
	 */
	public Flag setIdentifier(java.util.List<IdentifierDt> theValue) {
	...
	public BoundCodeDt<FlagStatusEnum> getStatusElement() {  
		if (myStatus == null) {
			myStatus = new BoundCodeDt<FlagStatusEnum>(FlagStatusEnum.VALUESET_BINDER);
		}
		return myStatus;
	}
	...
	public Flag setStatus(FlagStatusEnum theValue) {
		setStatus(new BoundCodeDt<FlagStatusEnum>(FlagStatusEnum.VALUESET_BINDER, theValue));
...
*/
	...
	/**
	 * Gets the value(s) for <b>period</b> (context).
	 * creating it if it does
	 * not exist. Will not return <code>null</code>.
	 *
     * <p>
	...
	/**
	 * Sets the value(s) for <b>period</b> (context)
	 *
     * <p>
     * <b>Definition:</b>
     * The period of time from the activation of the flag to inactivation of the flag. If the flag is active, the end of the period should be unspecified.
