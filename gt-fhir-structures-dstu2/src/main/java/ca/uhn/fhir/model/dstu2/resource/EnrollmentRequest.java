...
/**
 * HAPI/FHIR <b>EnrollmentRequest</b> Resource
 * ()
 *
 * <p>
 * <b>Definition:</b>
 ...
 * <a href="http://hl7.org/fhir/profiles/EnrollmentRequest">http://hl7.org/fhir/profiles/EnrollmentRequest</a> 
 * </p>
 *
 */
@ResourceDef(name="EnrollmentRequest", profile="http://hl7.org/fhir/profiles/EnrollmentRequest", id="enrollmentrequest")
public class EnrollmentRequest extends ca.uhn.fhir.model.dstu2.resource.BaseResource
	 ...
	 * </p>
	 */
	@SearchParamDefinition(name="subject", path="EnrollmentRequest.subject", description="The party to be enrolled", type="reference" , providesMembershipIn={
 @Compartment(name="Patient") 	}
	...
	@Child(name="coverage", order=8, min=1, max=1, summary=false, modifier=false, type={
	...
	public boolean isEmpty() {
		return super.isBaseEmpty() && ca.uhn.fhir.util.ElementUtil.isEmpty(  myIdentifier,  myRuleset,  myOriginalRuleset,  myCreated,  myTarget,  myProvider,  myOrganization,  mySubject,  myCoverage,  myRelationship);
	}
	
	@Override
	public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
		return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(theType, myIdentifier, myRuleset, myOriginalRuleset, myCreated, myTarget, myProvider, myOrganization, mySubject, myCoverage, myRelationship);
	}
     ...
     * </p> 
	 */
	public EnrollmentRequest setIdentifier(java.util.List<IdentifierDt> theValue) {
