...
public class Schedule extends ca.uhn.fhir.model.dstu2.resource.BaseResource
 ...
 @Compartment(name="Patient") ,  @Compartment(name="Encounter") ,  @Compartment(name="RelatedPerson") ,  @Compartment(name="Practitioner") 	}
	...
	@Child(name="type", type=CodeableConceptDt.class, order=1, min=0, max=Child.MAX_UNLIMITED, summary=false, modifier=false)	
	@Description(
	...
	@Child(name="actor", order=2, min=1, max=1, summary=true, modifier=false, type={
	...
	public boolean isEmpty() {
		return super.isBaseEmpty() && ca.uhn.fhir.util.ElementUtil.isEmpty(  myIdentifier,  myType,  myActor,  myPlanningHorizon,  myComment);
	}
	
	@Override
	public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
		return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(theType, myIdentifier, myType, myActor, myPlanningHorizon, myComment);
	}
	...
	/**
	 * Gets the value(s) for <b>actor</b> (who.focus).
	 * creating it if it does
	 * not exist. Will not return <code>null</code>.
	 *
     * <p>
	...
	/**
	 * Sets the value(s) for <b>actor</b> (who.focus)
	 *
     * <p>
     * <b>Definition:</b>
     * 
	...
	/**
	 * Gets the value(s) for <b>planningHorizon</b> (when.planned).
	 * creating it if it does
	 * not exist. Will not return <code>null</code>.
	 *
     * <p>
	...
	/**
	 * Sets the value(s) for <b>planningHorizon</b> (when.planned)
	 *
     * <p>
     * <b>Definition:</b>
     * 
