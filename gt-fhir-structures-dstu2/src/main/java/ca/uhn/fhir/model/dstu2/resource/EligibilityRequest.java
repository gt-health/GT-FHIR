...
/**
 * HAPI/FHIR <b>EligibilityRequest</b> Resource
 * ()
 *
 * <p>
 * <b>Definition:</b>
 ...
 * <a href="http://hl7.org/fhir/profiles/EligibilityRequest">http://hl7.org/fhir/profiles/EligibilityRequest</a> 
 * </p>
 *
 */
@ResourceDef(name="EligibilityRequest", profile="http://hl7.org/fhir/profiles/EligibilityRequest", id="eligibilityrequest")
public class EligibilityRequest extends ca.uhn.fhir.model.dstu2.resource.BaseResource
	...
	public boolean isEmpty() {
		return super.isBaseEmpty() && ca.uhn.fhir.util.ElementUtil.isEmpty(  myIdentifier,  myRuleset,  myOriginalRuleset,  myCreated,  myTarget,  myProvider,  myOrganization);
	}
	
	@Override
	public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
		return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(theType, myIdentifier, myRuleset, myOriginalRuleset, myCreated, myTarget, myProvider, myOrganization);
	}
     ...
     * </p> 
	 */
	public EligibilityRequest setIdentifier(java.util.List<IdentifierDt> theValue) {
