...
/**
 * HAPI/FHIR <b>BodySite</b> Resource
 * ()
 *
 * <p>
 * <b>Definition:</b>
 ...
 * <a href="http://hl7.org/fhir/profiles/BodySite">http://hl7.org/fhir/profiles/BodySite</a> 
 * </p>
 *
 */
@ResourceDef(name="BodySite", profile="http://hl7.org/fhir/profiles/BodySite", id="bodysite")
public class BodySite extends ca.uhn.fhir.model.dstu2.resource.BaseResource
	 ...
	 * </p>
	 */
	@SearchParamDefinition(name="patient", path="BodySite.patient", description="Patient to whom bodysite belongs", type="reference" , providesMembershipIn={
 @Compartment(name="Patient") 	}
	...
	@Description(
		shortDefinition="",
		formalDefinition="The person to which the body site belongs"
	)
	...
	@Description(
		shortDefinition="",
		formalDefinition="Identifier for this instance of the anatomical location."
	)
	...
	@Description(
		shortDefinition="",
		formalDefinition="Named anatomical location - ideally coded where possible."
	)
	private CodeableConceptDt myCode;
	
	@Child(name="modifier", type=CodeableConceptDt.class, order=3, min=0, max=Child.MAX_UNLIMITED, summary=false, modifier=false)	
	@Description(
		shortDefinition="",
		formalDefinition="Modifier to refine the anatomical location.  These include modifiers for laterality, relative location, directionality, number, and plane."
	)
	private java.util.List<CodeableConceptDt> myModifier;
	
	@Child(name="description", type=StringDt.class, order=4, min=0, max=1, summary=true, modifier=false)	
	@Description(
		shortDefinition="",
		formalDefinition="Description of anatomical location."
	)
	private StringDt myDescription;
	
	@Child(name="image", type=AttachmentDt.class, order=5, min=0, max=Child.MAX_UNLIMITED, summary=false, modifier=false)	
	@Description(
		shortDefinition="",
		formalDefinition="Image or images used to identify a location."
	)
	private java.util.List<AttachmentDt> myImage;
	

	@Override
	public boolean isEmpty() {
		return super.isBaseEmpty() && ca.uhn.fhir.util.ElementUtil.isEmpty(  myPatient,  myIdentifier,  myCode,  myModifier,  myDescription,  myImage);
	}
	
	@Override
	public <T extends IElement> List<T> getAllPopulatedChildElementsOfType(Class<T> theType) {
		return ca.uhn.fhir.util.ElementUtil.allPopulatedChildElements(theType, myPatient, myIdentifier, myCode, myModifier, myDescription, myImage);
	}
     ...
     * </p> 
	 */
	public BodySite setIdentifier(java.util.List<IdentifierDt> theValue) {
     ...
     * </p> 
	 */
	public java.util.List<CodeableConceptDt> getModifier() {  
		if (myModifier == null) {
			myModifier = new java.util.ArrayList<CodeableConceptDt>();
		}
		return myModifier;
	}
     ...
     * </p> 
	 */
	public BodySite setModifier(java.util.List<CodeableConceptDt> theValue) {
		myModifier = theValue;
		return this;
	}
     ...
     * </p> 
	 */
	public java.util.List<AttachmentDt> getImage() {  
		if (myImage == null) {
			myImage = new java.util.ArrayList<AttachmentDt>();
		}
		return myImage;
	}
     ...
     * </p> 
	 */
	public BodySite setImage(java.util.List<AttachmentDt> theValue) {
		myImage = theValue;
		return this;
	}
