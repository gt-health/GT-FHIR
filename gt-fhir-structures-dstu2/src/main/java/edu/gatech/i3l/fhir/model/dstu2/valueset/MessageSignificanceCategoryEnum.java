...
import edu.gatech.i3l.fhir.model.dstu2.valueset.MessageSignificanceCategoryEnum;
...
public enum MessageSignificanceCategoryEnum {
	 ...
	 */
	public static MessageSignificanceCategoryEnum forCode(String theCode) {
