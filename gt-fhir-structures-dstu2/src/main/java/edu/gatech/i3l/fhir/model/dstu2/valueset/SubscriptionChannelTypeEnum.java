...
import edu.gatech.i3l.fhir.model.dstu2.valueset.SubscriptionChannelTypeEnum;
...
public enum SubscriptionChannelTypeEnum {
	 ...
	 */
	public static SubscriptionChannelTypeEnum forCode(String theCode) {
