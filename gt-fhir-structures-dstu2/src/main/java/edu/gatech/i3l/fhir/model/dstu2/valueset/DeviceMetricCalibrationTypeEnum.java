...
import edu.gatech.i3l.fhir.model.dstu2.valueset.DeviceMetricCalibrationTypeEnum;
...
public enum DeviceMetricCalibrationTypeEnum {
	 ...
	 */
	public static DeviceMetricCalibrationTypeEnum forCode(String theCode) {
