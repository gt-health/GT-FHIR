...
import edu.gatech.i3l.fhir.model.dstu2.valueset.CompositionAttestationModeEnum;
...
public enum CompositionAttestationModeEnum {
	 ...
	 */
	public static CompositionAttestationModeEnum forCode(String theCode) {
