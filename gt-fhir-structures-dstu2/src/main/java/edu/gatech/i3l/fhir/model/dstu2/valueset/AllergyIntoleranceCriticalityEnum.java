...
import edu.gatech.i3l.fhir.model.dstu2.valueset.AllergyIntoleranceCriticalityEnum;
...
public enum AllergyIntoleranceCriticalityEnum {
	 ...
	 */
	public static AllergyIntoleranceCriticalityEnum forCode(String theCode) {
