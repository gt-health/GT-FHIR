...
import edu.gatech.i3l.fhir.model.dstu2.valueset.GoalStatusEnum;
...
public enum GoalStatusEnum {
	 ...
	 */
	ON_HOLD("on-hold", "http://hl7.org/fhir/goal-status"),
