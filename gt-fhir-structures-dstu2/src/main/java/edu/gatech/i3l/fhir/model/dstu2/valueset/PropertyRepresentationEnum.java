...
import edu.gatech.i3l.fhir.model.dstu2.valueset.PropertyRepresentationEnum;
...
public enum PropertyRepresentationEnum {
	...
	/**
	 * Display: <b>XML Attribute</b><br>
	 * Code Value: <b>xmlAttr</b>
	 *
	 * In XML, this property is represented as an attribute not an element.
	 */
	XML_ATTRIBUTE("xmlAttr", "http://hl7.org/fhir/property-representation"),
	 ...
	 */
	public static PropertyRepresentationEnum forCode(String theCode) {
