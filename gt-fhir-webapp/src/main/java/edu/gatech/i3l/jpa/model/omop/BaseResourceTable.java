...
public abstract class BaseResourceTable extends BaseHasResource implements IResourceTable{
	...
	public ResourceTag addTag(TagDefinition theTag) {
		ResourceTag tag = new ResourceTag(null, theTag);//FIXME IResource being passed as null 
