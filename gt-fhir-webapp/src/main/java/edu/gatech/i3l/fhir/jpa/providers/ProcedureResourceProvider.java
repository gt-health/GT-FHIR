...
public class ProcedureResourceProvider extends 
	JpaResourceProviderDstu3<Procedure>
	{
...
//			DateRangeParam theLastUpdated, 
			...
			@IncludeParam(allow = { "Procedure:patient", "Procedure:subject", "Procedure:encounter"}) 
