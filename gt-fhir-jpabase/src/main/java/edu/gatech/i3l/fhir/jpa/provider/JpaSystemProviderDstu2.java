...
public class JpaSystemProviderDstu2 extends BaseJpaSystemProvider<Bundle> {
	...
	// gls gt-fhir-structures-dstu2/target/generated-sources/tinder/ca/uhn/fhir/model/dstu2/resource/ | sort | sed "s/.java//" | sed "s/^/@OperationParam(name=\"/" | sed "s/$/\", type=IntegerDt.class, min=0, max=1),/"
